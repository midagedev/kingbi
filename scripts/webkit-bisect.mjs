// Bisect the WebKit white-screen: toggle composer passes, measure luminance.
...
async function measure(label) {
  await page.screenshot({ path: `shots/webkit-${label}.png` });
  const png = PNG.sync.read(fs.readFileSync(`shots/webkit-${label}.png`));
