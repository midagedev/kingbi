// 색광 화면 검증: demolish 리그(프레임 내 집 붕괴→점화) + 수치.
...
console.log('[light]', JSON.stringify(await page.evaluate(() => window.__THREE_GAME_TEST_HOOKS__?.voxelLightDebug() ?? [])));
await page.screenshot({ path: 'shots/voxlight-demolish.png' });
